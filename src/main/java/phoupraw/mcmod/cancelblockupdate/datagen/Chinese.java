...
final class Chinese extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder b) {
        ...
        b.add("modmenu.descriptionTranslation." + CancelBlockUpdate.MOD_ID, """
          ...
          建议搭配调整方块状态的调试棒使用。
          """);
        b.add(CBUGameRules.OFF.getDescriptionId(), modName + "：禁用模组全部效果");
        b.add(CBUGameRules.REPLACE.getDescriptionId(), modName + "：允许放置方块替换草、蕨");
        b.add(CBUGameRules.STACK_SLABS.getDescriptionId(), modName + "：允许半砖堆叠成双层半砖");
    }
