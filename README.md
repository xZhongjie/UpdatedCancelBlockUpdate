...
| `CancelBlockUpdate-1.1.2-mc1.21.4-1.21.8.jar` | 1.21.4 ~ 1.21.8 | `1.21.4` | [![Build](https://github.com/xZhongjie/UpdatedCancelBlockUpdate/actions/workflows/build.yml/badge.svg?branch=1.21.4)](https://github.com/xZhongjie/UpdatedCancelBlockUpdate/actions/workflows/build.yml) |
| `CancelBlockUpdate-1.1.2-mc1.21.8+.jar` | 1.21.8+ | `1.21.8` | [![Build](https://github.com/xZhongjie/UpdatedCancelBlockUpdate/actions/workflows/build.yml/badge.svg?branch=1.21.8)](https://github.com/xZhongjie/UpdatedCancelBlockUpdate/actions/workflows/build.yml) |
...
- **拿不准时**：选 `mc` 后缀覆盖你 MC 版本的 jar 即可（例如 MC 1.21.5 → 用 `CancelBlockUpdate-1.1.2-mc1.21.4-1.21.8.jar`）。
- `main` 分支指向最新的支持版本。
